...
/**
*
* @package phpBB Classifieds
* @version $Id: functions_version_check.php 1116 2009-04-16 12:53:57Z iantaylor $
...
function mod_version_check()
{
	...
	include($phpbb_admin_path . 'mods/classifeids_version.' . $phpEx);

	$class_name = 'classifieds_version';
